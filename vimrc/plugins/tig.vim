...
command! -bang -nargs=* TigLog          call vimrc#tig#log(<q-args>, <bang>0, 0)
command! -bang -nargs=* TigLogSplit     split | call vimrc#tig#log(<q-args>, <bang>0, 0)
command! -bang -nargs=* TigLogFile      call vimrc#tig#log(<q-args>, <bang>0, 1)
command! -bang -nargs=* TigLogFileSplit split | call vimrc#tig#log(<q-args>, <bang>0, 1)
