...
mapping.setup_mapping = function()
  ...
  vim.keymap.set(
    "x",
    "<C-W><Space>_",
    [[:call vimrc#utility#resize_height_to_selected()<CR>]],
    { desc = "Resize height to selected text lines" }
  )
  vim.keymap.set(
    "x",
    "<C-W><Space><Bar>",
    [[:call vimrc#utility#resize_width_to_selected()<CR>]],
    { desc = "Resize width to selected text columns" }
  )
  vim.keymap.set(
    "x",
    "<C-W><Space>x",
    [[:call vimrc#utility#resize_to_selected()<CR>]],
    { desc = "Resize to selected text lines & columns" }
  )
  vim.keymap.set(
    "n",
    "<C-W><Space>s",
    [[:call vimrc#utility#reset_sidebar_size()<CR>]],
  ...
  vim.keymap.set(
    ...
    "<Leader>du",
    [[:lcd ..<CR>]],
    { desc = "Change current window working directory to parent folder" }
  )
  ...
  vim.keymap.set(
    ...
    "<Leader>d5",
    [[:lcd %:h<CR>]],
    { desc = "Change current window working directory to folder containing current buffer" }
  )
  ...
  vim.keymap.set(
    "n",
    "zT",
    [['zt' . float2nr(winheight(0) * 0.25) . "\<C-Y>"]],
    { expr = true, desc = "Scroll to 1/4 top of window" }
  )
  vim.keymap.set(
    "n",
    "zB",
    [['zb' . float2nr(winheight(0) * 0.25) . "\<C-E>"]],
    { expr = true, desc = "Scroll to 1/4 bottom of window" }
  )
  ...
  vim.keymap.set(
    ...
    "<p",
    [["+[p]],
    { desc = "Paste before from system clipboard and adjust indent" },
    { remap = true }
  )
  vim.keymap.set(
    "n",
    ">p",
    [["+]p]],
    { desc = "Paste after from system clipboard and adjust indent" },
    { remap = true }
  )
  ...
  vim.keymap.set(
    ...
    "<Leader>y5",
    [[:let @" = expand('%:t:r')<CR>]],
    { desc = "Yank current filename without extension" }
  )
  vim.keymap.set(
    "n",
    "<Leader>y%",
    [[:let @" = @%<CR>]],
    { desc = "Yank current filename with relative path to current working directoy" }
  )
  ...
  vim.keymap.set(
    "c",
    "<C-G><C-M>",
    [[vimrc#fzf#mru#directory_mru_in_commandline()]],
    { expr = true, desc = "Fill directory MRU" }
  )
  vim.keymap.set(
    "i",
    "<C-G><C-M>",
  ...
  vim.keymap.set(
    "c",
    "<C-G><C-P>",
    [[vimrc#rg#current_type_option()]],
    { expr = true, desc = "Fill current type option for ripgrep" }
  )
  vim.keymap.set(
    "i",
    "<C-G><C-P>",
  ...
  vim.keymap.set(
    "c",
    "<C-G><C-L>",
    [[vimrc#rg#types_in_commandline()]],
    { expr = true, desc = "Fill types for ripgrep" }
  )
  vim.keymap.set(
    "i",
    "<C-G><C-L>",
  ...
  vim.keymap.set(
    ...
    "<C-G><C-W>",
    [["\\b" . expand('<cword>') . "\\b"]],
    { expr = true, desc = "Expand word with regex boundary" }
  )
  vim.keymap.set(
    "c",
    "<C-G><C-A>",
  ...
  vim.keymap.set(
    "c",
    "<C-G><C-O>",
    [[vimrc#fzf#git#commits_in_commandline(1, [])]],
    { expr = true, desc = "Fill buffer commits" }
  )
  vim.keymap.set(
    "i",
    "<C-G><C-O>",
  ...
  vim.keymap.set(
    "c",
    "<C-G><C-B>",
    [[vimrc#fzf#git#branches_in_commandline()]],
    { expr = true, desc = "Fill branches" }
  )
  vim.keymap.set(
    "i",
    "<C-G><C-B>",
  ...
  vim.keymap.set(
    "c",
    "<C-G><C-X>",
    [[vimrc#fzf#git#diff_files_in_commandline()]],
    { expr = true, desc = "Fill diff files" }
  )
  vim.keymap.set(
    "i",
    "<C-G><C-X>",
  ...
  vim.keymap.set(
    "c",
    "<C-G><C-V>",
    [[vimrc#utility#get_visual_selection()]],
    { expr = true, desc = "Get visual selection" }
  )
  ...
  vim.keymap.set(
    "c",
    "<C-X><C-B>",
    [[<C-\>e<Space>v:lua.require("vimrc.cmdline").delete_subword()<CR>]],
    { desc = "Delete subword" }
  )
  ...
  vim.keymap.set(
    "c",
    "<C-G>4",
    [[<C-R>=fnamemodify(@", ':p')<CR>]],
    { desc = "Insert register content with full path" }
  )
  vim.keymap.set(
    "i",
    "<C-G>4",
  ...
  vim.keymap.set(
    "c",
    "<C-G>5",
    [[<C-R>=fnamemodify(@", ':t:r')<CR>]],
    { desc = "Insert register content without extension" }
  )
  vim.keymap.set(
    "i",
    "<C-G>5",
  ...
  vim.keymap.set(
    "c",
    "<C-X><C-X>",
    [[vimrc#fzf#shell_outputs_in_commandline()]],
    { expr = true, desc = "Insert shell output" }
  )
  vim.keymap.set(
    "i",
    "<C-X><C-X>",
  ...
  vim.keymap.set(
    "o",
    "<Plug>(non-ascii-find)<M-s>",
    [[:<C-U>call vimrc#textobj#inner_surround_unicode()<CR>]],
    { silent = true }
  )
  ...
  vim.keymap.set(
    "o",
    "<Plug>(non-ascii-find)<M-S>",
    [[:<C-U>call vimrc#textobj#around_surround_unicode()<CR>]],
    { silent = true }
  )
  ...
  vim.keymap.set(
    "n",
    "<M-p>",
    [[:<C-U>call vimrc#textobj#past_character(v:count1, 'n', v:true)<CR>]],
    { silent = true }
  )
  vim.keymap.set(
    "x",
    "<M-p>",
    [[:<C-U>call vimrc#textobj#past_character(v:count1, 'v', v:true)<CR>]],
    { silent = true }
  )
  vim.keymap.set(
    "o",
    "<M-p>",
    [[:<C-U>call vimrc#textobj#past_character(v:count1, 'o', v:true)<CR>]],
    { silent = true }
  )
  vim.keymap.set(
    "n",
    "<M-P>",
    [[:<C-U>call vimrc#textobj#past_character(v:count1, 'n', v:false)<CR>]],
    { silent = true }
  )
  vim.keymap.set(
    "x",
    "<M-P>",
    [[:<C-U>call vimrc#textobj#past_character(v:count1, 'v', v:false)<CR>]],
    { silent = true }
  )
  vim.keymap.set(
    "o",
    "<M-P>",
    [[:<C-U>call vimrc#textobj#past_character(v:count1, 'o', v:false)<CR>]],
    { silent = true }
  )
...
mapping.setup_command = function()
  ...
  vim.api.nvim_create_user_command("ClearRegisters", [[call vimrc#utility#clear_registers(<q-args>)]], { nargs = 1 })
  ...
  vim.api.nvim_create_user_command("QuickfixFromCurrentBuffer", [[call vimrc#quickfix#build_from_buffer(bufnr())]], {})
  vim.api.nvim_create_user_command(
    "QuickfixFromBuffer",
