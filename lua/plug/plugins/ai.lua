  ...
  },
  {
    ...
    opts = {
      ...
      cli = {
        ...
        tools = {
          ...
          codex_review = { cmd = { "codex" }, url = "https://github.com/openai/codex" },
          codex_resume = {
            cmd = { "codex", "resume" },
          ...
          codex_astra = { cmd = { "codex", "-p", "astra" }, url = "https://github.com/openai/codex" },
          claude_new = {
            cmd = { "claude" },
    ...
    keys = {
      ...
      },
      {
        ...
        desc = "Sidekick Codex Oracle Toggle",
        mode = { "n", "v" },
      },
      {
        "<Leader>ax",
        function() require("sidekick.cli").toggle({ name = "codex_execute", focus = true }) end,
        desc = "Sidekick Codex Execute Toggle",
        mode = { "n", "v" },
      },
      {
        "<Leader>aq",
        function() require("sidekick.cli").toggle({ name = "codex_fast", focus = true }) end,
        desc = "Sidekick Codex Fast Toggle",
        mode = { "n", "v" },
      },
      {
        "<Leader>am",
        function() require("sidekick.cli").toggle({ name = "codex_mini_max", focus = true }) end,
        desc = "Sidekick Codex Mini Max Toggle",
        mode = { "n", "v" },
      },
      {
        "<Leader>az",
