...
terminal.setup = function()
  ...
  nnoremap("<Leader>tD", [[:call vimrc#terminal#open_shell('tabnew', input('Folder: ', '', 'dir'))<CR>]], "<silent>")
  ...
  -- Quickly paste from register
  vim.fn["vimrc#terminal#nested_neovim#register"]("<M-r>", ":execute 'normal! \"'.v:lua.require('vimrc.utils').get_char_string().'pi'<CR>")
