...
hop_extensions.setup = function()
  -- Treesitter
  map("<M-e>l", [[<Cmd>lua require('hop-extensions').ts.hint_locals({})<CR>]], { desc = "Hop locals" })
  map("<M-e>d", [[<Cmd>lua require('hop-extensions').ts.hint_definitions({})<CR>]], { desc = "Hop definitions" })
  map("<M-e>r", [[<Cmd>lua require('hop-extensions').ts.hint_references({})<CR>]], { desc = "Hop references" })
  map("<M-e>s", [[<Cmd>lua require('hop-extensions').ts.hint_scopes({})<CR>]], { desc = "Hop scopes" })
  map("<M-e>t", [[<Cmd>lua require('hop-extensions').ts.hint_textobjects({})<CR>]], { desc = "Hop all textobjects" })
  map("<M-e>x", [[<Cmd>lua require('hop-extensions').ts.hint_textobjects({}, '@call')<CR>]], { desc = "Hop call textobjects" })
  map(
    "<M-e>c",
