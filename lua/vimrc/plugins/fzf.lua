...
fzf.setup_mapping = function()
  ...
  vim.keymap.set("n", fzf_prefix .. [["]],     [[:call      vimrc#execute_and_save('RgWithOption ' . expand('%') . '::' . expand('<cword>'))<CR>]])
  vim.keymap.set("x", fzf_prefix .. [["]],     [[:call      vimrc#execute_and_save('RgWithOption ' . expand('%') . '::' . vimrc#utility#get_visual_selection())<CR>]])
