...
fzf.setup_mapping = function()
  ...
  xnoremap([[<Space>f4]],     [[:<C-U>call vimrc#execute_and_save('RgWithOption .:' . input('Option: ') . ':' . vimrc#utility#get_visual_selection())<CR>]])
  xnoremap([[<Space>f$]],     [[:<C-U>call vimrc#execute_and_save('RgWithOption! .:' . input('Option: ') . ':\b' . vimrc#utility#get_visual_selection() . '\b')<CR>]])
  nnoremap([[<Space>f?]],     [[:call      vimrc#execute_and_save('RgWithOption .:' . vimrc#rg#current_type_option() . ':' . input('Rg: '))<CR>]])
  xnoremap([[<Space>f?]],     [[:<C-U>call vimrc#execute_and_save('RgWithOption .:' . vimrc#rg#current_type_option() . ':' . vimrc#utility#get_visual_selection())<CR>]])
