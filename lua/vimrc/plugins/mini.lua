...
mini.setup_mapping = function()
  ...
  vim.keymap.set("n", mini_pick_lsp_prefix .. "s", [[<Cmd>Pick lsp scope='document_symbol'<CR>]])
  vim.keymap.set("n", mini_pick_lsp_prefix .. "S", [[<Cmd>Pick lsp scope='workspace_symbol'<CR>]])
