...
lsp.on_attach = function(client, bufnr)
  ...
  end, "silent", "buffer", { desc = "LSP show hover documentation" })
  nnoremap("gD", function()
    vim.lsp.buf.definition()
  end, "silent", "buffer", { desc = "LSP show definition" })
  nnoremap("1gD", function()
    vim.lsp.buf.type_definition()
  end, "silent", "buffer", { desc = "LSP show type definition" })
  nnoremap("gR", function()
    vim.lsp.buf.references()
  end, "silent", "buffer", { desc = "LSP show references" })
  nnoremap("g0", function()
    vim.lsp.buf.document_symbol()
  end, "silent", "buffer", { desc = "LSP show document symbol" })
  nnoremap("gy", function()
    vim.lsp.buf.signature_help()
  end, "silent", "buffer", { desc = "LSP show signature help" })
  nnoremap("<Space>lf", function()
    vim.lsp.buf.format({ async = true })
  end, "silent", "buffer", { desc = "LSP format" })
  ...
  end, "silent", "buffer", { desc = "LSP show info" })
  nnoremap("yof", function()
    require("vimrc.lsp").toggle_format_on_sync()
  end, "silent", "buffer", { desc = "LSP toggle format on sync" })
  nnoremap("yoo", function()
    require("vimrc.lsp").toggle_show_diagnostics()
  end, "silent", "buffer", { desc = "LSP toggle show diagnostics" })
  nnoremap("yoI", function()
    vim.lsp.inlay_hint.enable(not vim.lsp.inlay_hint.is_enabled())
  end, "silent", "buffer", { desc = "LSP toggle inlay hints" })
